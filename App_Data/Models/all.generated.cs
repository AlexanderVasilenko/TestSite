...
{
	// Mixin content Type 1058 with alias "BlogPost"
...
#pragma warning restore 0109
		...
		public static Newtonsoft.Json.Linq.JToken GetContent(IBlogPost that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JToken>("content"); }
		...
		public static string GetIntroduction(IBlogPost that) { return that.GetPropertyValue<string>("introduction"); }
	}
...
#pragma warning restore 0109
	...
	// Mixin content Type 1061 with alias "LandingPage"
...
#pragma warning restore 0109
		...
		/// <summary>Static getter for Content</summary>
		public static Newtonsoft.Json.Linq.JToken GetContent(ILandingPage that) { return that.GetPropertyValue<Newtonsoft.Json.Linq.JToken>("content"); }
		...
		public static bool GetUmbracoNaviHide(ILandingPage that) { return that.GetPropertyValue<bool>("umbracoNaviHide"); }
	}
...
#pragma warning restore 0109
	...
	/// <summary>Events Repository</summary>
	[PublishedContentModel("eventsRepository")]
	public partial class EventsRepository : PublishedContentModel, ILandingPage
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "eventsRepository";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public EventsRepository(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<EventsRepository, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
		...
		public Newtonsoft.Json.Linq.JToken Content
		{
			get { return LandingPage.GetContent(this); }
		}
		...
		public bool UmbracoNaviHide
		{
			get { return LandingPage.GetUmbracoNaviHide(this); }
		}
	}

	/// <summary>Event Item</summary>
	[PublishedContentModel("eventItem")]
	public partial class EventItem : PublishedContentModel, IBlogPost
	{
#pragma warning disable 0109 // new is redundant
...
#pragma warning restore 0109
		...
		public Newtonsoft.Json.Linq.JToken Content
		{
			get { return BlogPost.GetContent(this); }
		}
		...
		public string Introduction
		{
			get { return BlogPost.GetIntroduction(this); }
		}
	}
